...
cardano-cli address build --payment-script-file plutus/pool_script.plutus --stake-verification-key-file keys/pools-stake.vkey --mainnet --out-file plutus/pool.addr
